...
import static ru.m210projects.Redneck.Actors.actor_tog;
import static ru.m210projects.Redneck.Globals.*;
import static ru.m210projects.Redneck.Main.*;
import static ru.m210projects.Redneck.RSector.operateforcefields;
import static ru.m210projects.Redneck.RSector.operatesectors;
import static ru.m210projects.Redneck.View.*;
import static ru.m210projects.Redneck.Weapons.addammo;
            ...
            if (message.equalsIgnoreCase(cheatCode[nCheatCode])) {
                switch (nCheatCode) {
                    ...
                    case 13: // dncashman
                        ...
                        break;
                    case 8: // rdunlock
                        for (int i = boardService.getSectorCount() - 1; i >= 0; i--) //Unlock
                        {
                            ...
                            if ((j & 0x7fff) > 2) {
                                if ((j & (0xffff - 16384)) != 0) {
                                    sec.setLotag(sec.getLotag() & (0xffff - 16384));
                                }
                    ...
                    case 18: //rdhounddog
                        ...
                        if (ud.god) {
                            ...
                            psp.setHitag(0);
                            psp.setLotag(0);
                            ps[myconnectindex].getPlayerSprite().setPal(ps[myconnectindex].palookup);
